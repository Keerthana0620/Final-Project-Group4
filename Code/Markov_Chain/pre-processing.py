...
data.to_csv('/content/drive/Othercomputers/My MacBook Pro/DATS6312/Project/ApoorvaReddy-Bagepalli-individual-project/Final Project/final_1.csv',index=False)